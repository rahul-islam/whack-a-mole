...
let canHit = true;
var moleIndex = 0;
var hand, handx, handy, playerPose, correct,gameFont;
...
function evaluateHit() {
    if(playerPose && playerPose.pose.rightWrist.confidence > 0.4 ) {
        ...
        var isHit = isInside(holes[moleIndex].x, holes[moleIndex].y, holes[moleIndex].r, rNorm[0]*Rx*canvas.width, rNorm[1]*Ry*canvas.height);
...
function assignPlayerPose(poses) {
    let confidence = 0;
